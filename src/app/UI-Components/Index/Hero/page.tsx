...
export default function Hero() {
	return (
		<>
						...
						<div className="w-full lg:w-1/2 relative">
							<div className="">
								...
								<p className="text-gray-600 w-full md:w-[60%]">
									Whether is your home, office or a commercial project,we are
									always dedicated your vision to life.
								</p>
			...
			<div className="w-full px-[8%] lg:px-[12%] pb-10">
				<Swiper
					slidesPerView={5}
					spaceBetween={30}
					loop={true}
          ...
          {Partners.map((partner, index) => (
            <SwiperSlide key={index}>
              <Image src={partner} alt="PartnerImage" className="partner-img" />
            </SwiperSlide> ))}
        </Swiper>
			</div>
		</>
