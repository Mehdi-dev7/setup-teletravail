			...
			<div className="px-[8%] lg:px-[12%] py-30 pb-20">
				<div className="flex flex-col lg:flex-row gap-10">
					<div className="w-full lg:w-1/3 title pt-8">
						<span className="rounded-full title-span border border-gray-400 px-7 GolosText uppercase font-bold py-2">
							Your latest Blogs
						</span>
					</div>
					<div className="w-full lg:w-2/3">
						<h1 className="CalSans text-4xl md:text-7xl mb-5 w-full lg:w-[80%]">
							{" "}
							Take A look At{" "}
							<span className="text-(--prim)">Our Latest Blog</span> & Articles.
						</h1>
					</div>
				</div>
