    ...
    return (
      <div className="section-bg text-white flex flex-col">
        ...
        <div className="flex items-center gap-5 mt-3">
          <Link href="/UI-Components/Projects" className="hover:text-(--prim) transition-all duration-300 mt-5 border border-gray-300 px-4 py-2 rounded hover:bg-white">Back to Projects</Link>
        </div>
      </div>
    )
  }
